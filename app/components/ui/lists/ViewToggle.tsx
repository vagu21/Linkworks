  ...
  return (
    <span className="relative z-0 inline-flex rounded-md shadow-sm">
      <button
        ...
        type="button"
        className={clsx(
          "focus:border-accent-500 focus:ring-accent-500 relative inline-flex items-center rounded-l-md border border-gray-300 px-4 py-2.5 text-sm font-medium hover:bg-gray-100 focus:z-10 focus:outline-none focus:ring-1",
