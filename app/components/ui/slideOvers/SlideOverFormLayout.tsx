...
import { Dialog, DialogPanel, DialogTitle, Menu, Transition, TransitionChild } from "@headlessui/react";
...
export default function SlideOverFormLayout({
  title,
  description,
  children,
  onClosed,
        ...
        >
          <div className="absolute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
              ...
              >
                <DialogPanel className={clsx("pointer-events-auto w-screen", className)}>
