...
import { Links, Meta, Outlet, Scripts, ScrollRestoration, useActionData, useLoaderData, useLocation, useMatches, useSearchParams } from "@remix-run/react";
import "./globals.css";
import "./themes.css";
    ...
    >
      ...
      <body
        className={clsx(
          ...
          "text-foreground max-h-full min-h-screen max-w-full",
          ["app/", "admin/"].some((p) => location.pathname.startsWith(`/${p}`)) ? "bg-gray-50" : ""
        )}
      >
