          ...
          if (type === "application/pdf" && file) {
            try {
              ...
              if (openAiJson) {
                ...
                if (!allEducationTent || !allEducationTent.rowsData || !allEducationTent.rowsData.items) {
                ...
                if (!allWorkExperienceTent || !allWorkExperienceTent.rowsData || !allWorkExperienceTent.rowsData.items) {
