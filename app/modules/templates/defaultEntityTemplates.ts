...
export const ACTION_ENTITY_TEMPLATE: EntitiesTemplateDto = {
    entities: [
      {
        type: "admin",
        name: "Actions",
        ...
        properties: [
          ...
          },
          {
            ...
            showInCreate: true,
            options: [
              { value: "Candidate", color: 0 },
              { value: "Job", color: 0 },
              { value: "Account", color: 0 },
              { value: "Job Application", color: 0 },
              { value: "Contact", color: 0 },
              { value: "Interview Meetings", color: 0 },
            ],
          },
          {
            name: "type",
            ...
            options: [
              { value: "POST", color: 0 },
              { value: "GET", color: 0 },
              { value: "DELETE", color: 0 },
              { value: "DOWNLOAD", color: 0 },
              { value: "NAVIGATE", color: 0 },
              { value: "UPDATE", color: 0 },
              { value: "SUMMARY", color: 0 },
            ],
          },
          {
            name: "triggers",
            ...
            showInCreate: true,
            options: [
              { value: "On Create", color: 0 },
              { value: "On Edit", color: 0 },
              { value: "On Overview", color: 0 },
              { value: "On Tables", color: 0 },
            ],
          },
          {
            name: "apiEndPoint",
...
export const ADDRESS_ENTITY: EntitiesTemplateDto = {
  entities: [
    {
      type: "app",
      name: "Address",
      ...
      properties: [
        ...
        {
          name: "flatHouseNoBuildingCompanyApartment",
