          ...
          <div className="space-y-4 px-4 py-4">
            ...
            <Fragment>
              <div className="space-y-3">
                <div className="text-sm font-medium text-gray-700">Workflow Params</div>
                <div className="space-y-1">
                  <div className="overflow-hidden">
                    {typeof window !== "undefined" && (
                      <Editor
                        ...
                        className="focus:border-accent-500 focus:ring-accent-500 -ml-10 block h-32 w-full min-w-0 flex-1 rounded-md border-gray-300 sm:text-sm"
                        theme="vs-dark"
                      />
                    )}
                  </div>
            ...
            <Fragment>
              ...
              <div className="space-y-3">
                <div className="text-sm font-medium text-gray-700">Workflow Output</div>
                <div className="space-y-1">
                  <div className="overflow-hidden">
                    <Editor
          ...
          <Link to={UrlUtils.getModulePath(params, `workflow-engine/workflows/${workflow.id}/run/api`)}>
            <div className="rounded-md border border-dashed border-gray-300 bg-gray-50 p-3 hover:border-dotted hover:border-gray-800 hover:bg-gray-100">
              <div className="space-y-1">
                ...
                <div className=" text-xs text-gray-600">Call the workflow using the API.</div>
              </div>
            </div>
          </Link>
          <Link to={UrlUtils.getModulePath(params, `workflow-engine/workflows/${workflow.id}/run/stream`)}>
            <div className="rounded-md border border-dashed border-gray-300 bg-gray-50 p-3 hover:border-dotted hover:border-gray-800 hover:bg-gray-100">
              <div className="space-y-1">
                ...
                <div className=" text-xs text-gray-600">Get interactive output from the workflow.</div>
              </div>
            </div>
          </Link>
        </div>
