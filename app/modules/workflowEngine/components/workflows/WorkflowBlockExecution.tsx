      ...
      <div className="">
        ...
        <div className="space-y-4 px-4 py-4">
          <div className="space-y-2">
            ...
            <div>
              <div className="w-full rounded-lg bg-gray-100 px-1 py-1 text-sm text-gray-500 focus:outline-none">
            ...
            <Fragment>
              ...
              {blockRun.input && (
                <Fragment>
                  ...
                  <div className="space-y-3">
                    <div className="text-sm font-medium text-gray-700">Workflow Block Input</div>
              ...
              {blockRun.output && (
                <Fragment>
                  <div className="border-border border-t"></div>
                  <div className="space-y-3">
                    <div className="text-sm font-medium text-gray-700">Workflow Block Output</div>
                    <div className="space-y-1">
                      <div className="overflow-hidden">
                        <Editor
