...
const StatCard = ({ charTitle, charSubTitle, chartDescription, numericData }: any) => {
  return (
    <>
      <Card className="flex h-[200px]  flex-col justify-center text-center">
        ...
        <CardContent className="flex-1 pb-0">
          <div className="flex justify-center">
            <div className="mt-4 items-center text-4xl font-bold">
        ...
        <CardFooter className="flex-col gap-2 text-sm">
          ...
          <div className="text-muted-foreground leading-none ">{chartDescription}</div>
        </CardFooter>
      </Card>
    </>
  );
